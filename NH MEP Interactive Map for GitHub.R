...
ui <- fluidPage(
  ...
  div(
    ...
    img(src = "https://raw.githubusercontent.com/your-username/your-repository-name/main/www/NH%20Manufacturing%20Interactive%20Search%20Map%20for%20Supply%20Chain%20Inventory.jpg", 
        class = "header-graphic")
  ),
